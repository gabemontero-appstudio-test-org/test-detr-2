...
3) Access the `workbench` named `test-of-object-detection-2-notebook`.
...
5) In the terminal, run `cd test-of-object-detection-2` to navigate to your sample app's directory.
